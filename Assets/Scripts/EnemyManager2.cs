        ...
        for (int i = 0; i < numEnemies; i++)
        {
             if (_enemy[i] == null)
             {
                ...
                if (Random.Range(0,2) == 0) {
                    _enemy[i].transform.position = new Vector3(Random.Range(-10, 10), 1, Random.Range(-10, 10));
                }
                else {
                    _enemy[i].transform.position = new Vector3(Random.Range(85, 60), 1, Random.Range(-10, 10));
                }
